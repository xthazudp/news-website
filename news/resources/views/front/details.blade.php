...
<div class="widget hidden-xs m30">
    ...
    <img class="img-responsive adv_img" src="{{ asset('public/front/img/right_add2.jpg')}} right_add2.jpg" alt="add_one">
    <img class="img-responsive adv_img" src="{{ asset('public/front/img/right_add3.jpg')}} right_add3.jpg" alt="add_one">
    <img class="img-responsive adv_img" src="{{ asset('public/front/img/right_add4.jpg')}} right_add4.jpg" alt="add_one">
</div>
<!-- Advertisement -->
