            ...
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{ asset('public/post') }}/{{ $item->main_image }}"  alt="{{ $item->title }}">
                    </div>
                    <!-- feature_article_img -->
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="{{ url('/details') }}/{{$item->slug }}" target="_self">{{ $item->title }} </a></h1>
                        </div>
                         <!-- feature_article_title -->

                        <div class="feature_article_date">
                            <a href="{{ url('/author') }}/{{ $item->creator->id }}" >{{ $item->creator->name }}</a>,
                                <a>{{ date('F j,Y',strtotime( $item->created_at )) }}</a>
                        </div>
